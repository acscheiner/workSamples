...
public class GameShareInfoTest {
    ...
    public void testObjEquality() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
    ...
    public void testObjInequalityGameTitle() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "Pink Sapphires",
                Integer.valueOf(12), gameRecallData);
    ...
    public void testObjInequalityCentsWon() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(13), gameRecallData);
        assertFalse(gsInfo.equals(gsInfo2));
    }
    ...
    public void testObjInequalityGameRecall() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData + "  Or Not!");
        assertFalse(gsInfo.equals(gsInfo2));
    }
    ...
    public void testObjInequalityCasino() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Galaxy", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        assertFalse(gsInfo.equals(gsInfo2));
    }
    ...
    public void testObjInequalityCabinetType() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Galaxy", "Retros", "New Money",
                Integer.valueOf(12), gameRecallData);
        assertFalse(gsInfo.equals(gsInfo2));
    }
    ...
    public void testObjInequalityGamePlayedAt() {
        ...
        final GameShareInfo gsInfo = new GameShareInfo(Long.valueOf(1461870653220L), "Lucky Star", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        final GameShareInfo gsInfo2 = new GameShareInfo(Long.valueOf(1461870643220L), "Lucky Galaxy", "Atlas", "New Money",
                Integer.valueOf(12), gameRecallData);
        assertFalse(gsInfo.equals(gsInfo2));
    }
}
